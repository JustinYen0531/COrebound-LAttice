...
小隊成員共計 **20 名**，分為 **5 個戰術家族**，並各自散落於 **4 個主題世界** 中。每個世界鋪有 5 名代表不同家族的成員。
...
* **🎯 向量 (Vector) - 直線家族**
  ...
  * **多樣性機制類別**：**【個體機制 (Individual Specialists)】**
  * **星級機制成長 (Star Progression)**：
    * **1 星 (1★)**：**【極限狙殺】** ── 僅對自身有效。向量對距離小隊 `8` 距離單位以上的敵方目標造成的傷害提升 `25%`。
    * **2 星 (2★)**：遠程傷害加成提升至 `45%`，且向量自身的子彈射程增加 `15%`。
    * **3 星 (3★) 質變分支**：
      * **分支 A【貫穿射線】**：向量的子彈獲得 `100%` 的穿透判定，能穿透低碰撞重量的敵方雜兵與子彈，直接打擊後排目標。
      * **分支 B【致命一擊】**：對生命值高於 `80%` 的敵方目標造成的首發傷害增加 `80%`，非常適合起手開團。
...
* **🛡️ 荊棘 (Thorn) - 護盾家族**
  ...
  * **多樣性機制類別**：**【個體機制 (Individual Specialists)】**
  * **星級機制成長 (Star Progression)**：
    * **1 星 (1★)**：**【棘刺盾面】** ── 僅對自身有效。荊棘護盾被撞擊時，反彈給對方的反彈傷害提升 `30%`，且自身受到的子彈碰撞重量壓力減免 `15%`。
    * **2 星 (2★)**：反彈傷害提升至 `50%`，受到的子彈碰撞壓力減免提升至 `25%`。
    * **3 星 (3★) 質變分支**：
      * **分支 A【荊棘枷鎖】**：反彈傷害提升至 `80%`；且任何撞擊荊棘防線的敵方目標，其移動速度降低 `40%`，持續 1.5 秒。
      * **分支 B【鐵木嘲諷】**：每 8 秒自動朝周圍散發一次「自然共鳴」，強制引導周邊所有敵方雜兵和子彈朝荊棘的方向前進，持續 2.0 秒（期間荊棘獲得 `40%` 的霸體減免）。
...
* **💣 深淵 (Abyss) - 地雷家族**
  ...
  * **多樣性機制類別**：**【個體機制 (Individual Specialists)】**
  * **星級機制成長 (Star Progression)**：
    * **1 星 (1★)**：**【深淵凝視】** ── 僅對自身有效。深淵地雷獲得 `15%` 的碰撞體積感應範圍，且自身對 Boss 級敵人造成的傷害提升 `20%`。
    * **2 星 (2★)**：碰撞體積感應範圍提升至 `30%`，對 Boss 造成的傷害提升至 `40%`。
    * **3 星 (3★) 質變分支**：
      * **分支 A【無限引力】**：深淵地雷自身的引力牽引範圍擴大 `50%`；且地雷在爆炸時會將周圍的所有敵人向中心強行拉攏，造成 1.5 秒的禁錮。
      * **分支 B【鏡面嘲諷】**：深淵每 `10 秒` 在自身位置生成一面持續 2.5 秒的「鏡面幻影」，強制引導並吸引周圍敵人的子彈與仇恨（冷卻時間 12 秒）。
...
* **💥 彈片 (Shrapnel) - 多發家族**
  ...
  * **多樣性機制類別**：**【個體機制 (Individual Specialists)】**
  * **星級機制成長 (Star Progression)**：
    * **1 星 (1★)**：**【碎片絞殺】** ── 僅對自身有效。彈片身邊高速旋轉的機械碎片，對靠近的敵方目標造成的流血持續傷害提升 `30%`。
    * **2 星 (2★)**：流血傷害提升至 `50%`，且彈片自身的基礎攻擊力增加 `15%`。
    * **3 星 (3★) 質變分支**：
      * **分支 A【崩壞過載】**：流血傷害提升至 `80%`；且彈片在擊殺敵人時，身邊的旋轉碎片會瞬間擴大一圈，將絞殺範圍提升 `50%`，持續 3.0 秒。
      * **分支 B【鋼鐵壁壘】**：彈片自身獲得 `20%` 的物理減傷；且身邊的旋轉碎片每 5 秒會自動消除一顆進入其軌跡的敵方子彈。
...
* **⚡ 電弧 (Arc) - 激光家族**
  ...
  * **定位**：高溫聚焦熔融光束，射擊時間越長，對單一目標 the 破防與傷害效果越強。
  * **角色概念 (Soul Concept)**：
