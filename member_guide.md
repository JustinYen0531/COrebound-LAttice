...
* **核心理念**：
  ...
  這裡不是自然生長，也不是工業裝配，而是**自相似遞歸複製**。分形世界的「效果位」偏向於神祕的**自動施法 (Auto-Casters)** 機制，其自動冷卻由**傷害結算 Tick** 的累計次數控制。
* **視覺規則 (Visual Rules)**：
...
* **💣 深淵 (Abyss) - 地雷家族**
  ...
  * **星級機制成長 (Star Progression)**：
    ...
    * **3 星 (3★) 質變分支**：
      ...
      * **分支 B【鏡面折射】**：自身最大生命值提升至 `40%`；且自身每隔 `5 次傷害 Tick` 獲得最大生命 `8%` 的個人護盾，當護盾被擊碎時，`50%` 的機率自動在原地釋放微型引力震盪波小幅擊退周圍敵人。
